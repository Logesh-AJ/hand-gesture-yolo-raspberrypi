...
This project demonstrates a **real-time hand gesture control system** running on a Raspberry Pi with a Pi Camera. It uses **YOLO-based object detection** combined with **MediaPipe preprocessing** to recognize gestures and control system states.
