#toggle controls if 60% of the frames for 3 sec is the same
#to close press q 
...
while True:
    ...
    if time.time() - start_time >= 3:
        ...
        if gesture_id is not None and percent >= 60:
            action = gesture_actions.get(gesture_id, "Unknown Gesture")
            if gesture_id == 0:
    ...
    # Recent message
    cv2.putText(status_screen, f"Last Msg:", (10, 310), font, 0.7, (0, 0, 0), 2)
